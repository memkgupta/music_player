...
import com.example.musicplayerapp.databinding.FavouriteViewBinding
...
//    @SuppressLint("SuspiciousIndentation")
    ...
    holder.name.text = musicList[position].title
        Glide.with(context).load(musicList[position].artUri).apply(RequestOptions().placeholder(R.drawable.icon)).into(holder.image);
